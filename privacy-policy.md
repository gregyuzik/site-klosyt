...
We want to be completely transparent: **Klosyt collects nothing.**

| Data Type | Collected? | Details |
|-----------|-----------|---------|
| Photos & Images | ❌ No | Stored only on your device and your personal iCloud account. We never receive or access them. |
| Location | ❌ No | Weather features use Apple's WeatherKit, which processes location entirely on Apple's servers. Your location is never sent to us. |
| Klosyt Data | ❌ No | Clothing items, outfits, calendar entries, and preferences stay on your device and in your personal iCloud account. |
| Names or Emails | ❌ No | We do not collect any personally identifiable information. |
| Usage Analytics | ❌ No | We do not track how you use the App. |
| Advertising Data | ❌ No | There are no ads in Klosyt and no advertising SDKs. |
...
If you experience an issue and choose to contact us for support, you may use the in-app diagnostic sharing feature to send us a report. This report may include your device model, OS version, app version, and storage statistics. **This only happens when you explicitly choose to share it.** We use this information solely to troubleshoot your issue and do not retain it beyond that purpose.
...
Klosyt+ is an optional auto-renewable subscription processed entirely by Apple through the App Store. We do not have access to your payment information. You can manage or cancel your subscription at any time in your Apple ID settings.

## Children's Privacy

We do not knowingly collect personal information from anyone, including children under 13. Since Klosyt collects no personal information from any user, there is no age-specific data handling required.

## Your Rights (International)
...
This website (klosyt.com) uses Google Analytics 4 in cookieless mode to count aggregate page views. We configure gtag.js with `client_storage: 'none'`, `allow_google_signals: false`, and `allow_ad_personalization_signals: false`. GA4 anonymizes IP addresses automatically, so no `_ga` cookie is set and no advertising identifiers are collected. The Klosyt app itself does not include analytics.
...
If you have any questions or concerns about this Privacy Policy, please contact Klosyt at [support@klosyt.com](mailto:support@klosyt.com).
