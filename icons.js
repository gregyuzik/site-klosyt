...
(function () {
    ...
    var icons = {
        ...
        '🚀': { d: 'M18 11v2.18c0 .53-.21 1.04-.59 1.41L14 18h-1.5l.71-4H8.96l-.22 1.12c-.07.37-.39.63-.76.63H7l.22-1.12L8.5 8h7c1.1 0 2 .9 2 2v1zm-3.5-5h-6l-.67 3h6.84L14.5 6zM5 8l-.73 3.66A1.98 1.98 0 006.2 14H7l1-5.27L8.5 6H6l-1 2z', g: ['#ff9500', '#ffcc00'] },
        '👑': { d: 'M12 3l2.5 5.5L20 6l-2 7H6L4 6l5.5 2.5L12 3zM5 15h14c.55 0 1 .45 1 1v1c0 .55-.45 1-1 1H5c-.55 0-1-.45-1-1v-1c0-.55.45-1 1-1z', g: ['#B38000', '#D9A621'] },
